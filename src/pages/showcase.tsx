    ...
    <div>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.lightLine}/>
        {
          thirdPng.map((item,index)=>(
            <div className={styles.wrapper} style={{border:'none',paddingTop:index!==0?'0':'120px'}}>
              ...
              <div className={styles.cardimg} data-status= {item.position === 'right' ? 'right' :"left"} ><img src={item.svg} width={'100%'} height={'100%'} /></div>
                <div className={styles.cardtext} data-status={item.position === 'right' ? 'right' :"left"}>
        ...
        <div className={styles.fourthcontainer}>
          ...
          <button className={styles.github} onClick={()=>window.open('https://github.com/KittenBot/agilewhisker-web')}>
        ...
        <div className={styles.wrapper}>
          ...
          <div className={styles.link}>
            <button className={styles.discord} onClick={()=>{window.open('https://discord.gg/rsfpJAR2')}}>
            <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
