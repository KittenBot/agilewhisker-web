...
const items: CollapseProps['items'] = [
  {
    key: '1',
    label: 'What is Whisker？ 1',
    children: <p>{text}</p>,
  },
  {
    key: '2',
    label: 'What is Whisker？ 2',
    children: <p>{text}</p>,
  },
  {
    key: '3',
    label: 'What is Whisker？ 3',
    children: <p>{text}</p>,
  },
  {
    key: '4',
    label: 'What is Whisker？ 4',
    children: <p>{text}</p>,
  },
  {
    key: '5',
    label: 'What is Whisker？ 5',
    children: <p>{text}</p>,
  },
];
    ...
    <Layout title={`sharecase`} description="">
      <div className={styles.container}>
        ...
        <div className={styles.fourthcontainer}>
          ...
          <p>
          Our web-based SKILL platform allows users to browse and customize effortlessly, ditching all connection software. Change SKILL as you wish.
          </p>
        </div>
        <div className={styles.wrapper}>
          <h1>
